...
test('should be add new task in state and make title', () => {
	...
	const action = addTaskToolkitAC({ todoListId: todoListId1, value: 'newTask' })
...
test('should be delete task with state', () => {
	...
	const action = deleteTaskToolkitAC({ id: idAC, todoListId: todoListId1 })
	const endState = tasksSlice.reducer(startState, action)
...
test('should be change task title', () => {
	...
	const action = changeTaskToolkitAC({
		title: value,
...
test('status of specified task should be changed', () => {
	...
	const action = changeStatusToolkitAC({
		taskId: '1',
		isDone: false,
		todoListId: todoListId1,
	})
...
test('new property with new array should be added when new todoList is added', () => {
	...
	const action = addTodoListInTask('title no matter')
...
test('property width todoList should be deleted', () => {
	...
	const action = removeTodoListInTask(todoListId1)
